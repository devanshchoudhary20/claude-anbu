...
2. Local: use Claude in Chrome. Cloud: use Playwright MCP headless. Same script either way: for every screen, drive the happy path, then force the empty, loading, and error states (block the network request, clear storage, send bad input).
